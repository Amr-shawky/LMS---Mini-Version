...
{
    public class GetTrackByIdQueryHandler : IRequestHandler<GetTrackByIdQuery, TrackDetailViewModel>
    {
        ...
        public async Task<TrackDetailViewModel> Handle(GetTrackByIdQuery request, CancellationToken cancellationToken)
        {
