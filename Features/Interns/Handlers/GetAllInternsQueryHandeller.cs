...
{
    public class GetAllInternsQueryHandeller:IRequestHandler<GetAllInternsQuery, IEnumerable<InternDto>>
    {
        private readonly IGeneralRepository<Intern> _internRepository;
        public GetAllInternsQueryHandeller(IGeneralRepository<Intern> internRepository)
        {
